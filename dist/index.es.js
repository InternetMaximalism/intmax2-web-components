...
const B = "-", ie = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const s = a.split(B);
      return s[0] === "" && s.length !== 1 && s.shift(), D(s, r) || ae(a);
    },
  ...
  return pe(Object.entries(e.classGroups), t).forEach(([n, a]) => {
    $(a, o, n, r);
  }), o;
}, $ = (e, r, t, o) => {
  e.forEach((l) => {
...
}, de = (e) => e.isThemeGetter, pe = (e, r) => r ? e.map(([t, o]) => {
  ...
  for (let u = a.length - 1; u >= 0; u -= 1) {
    ...
    const p = ge(m).join(":"), f = y ? p + ee : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const R = l(b, w);
...
function xe(e, ...r) {
  ...
  function a(u) {
    ...
    return t = fe(g), o = t.cache.get, l = t.cache.set, n = s, s(u);
  }
  function s(u) {
    const g = o(u);
    if (g)
...
const c = (e) => {
...
}, te = /^\[(?:([a-z-]+):)?(.+)\]$/i, we = /^\d+\/\d+$/, ve = /* @__PURE__ */ new Set(["px", "full", "screen"]), ke = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Ce = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ze = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Ae = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Se = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || ve.has(e) || we.test(e), z = (e) => G(e, "length", Ee), M = (e) => !!e && !Number.isNaN(Number(e)), _ = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), Me = (e) => e.endsWith("%") && M(e.slice(0, -1)), i = (e) => te.test(e), A = (e) => ke.test(e), Ge = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Re = (e) => G(e, Ge, oe), Ie = (e) => G(e, "position", oe), Pe = /* @__PURE__ */ new Set(["image", "url"]), je = (e) => G(e, Pe, Le), Ne = (e) => G(e, "", Te), j = () => !0, G = (e, r, t) => {
  const o = te.exec(e);
  ...
  Ce.test(e) && !ze.test(e)
), oe = () => !1, Te = (e) => Ae.test(e), Le = (e) => Se.test(e), We = () => {
...
const _e = se.forwardRef(
  ({ className: e, type: r, ...t }, o) => /* @__PURE__ */ ne(
    "input",
    {
      type: r,
      className: Oe(
